    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body { background: #000000; color: #e8edf5; font-family: var(--font); font-size: 16px; line-height: 1.7; font-weight: 400; overflow-x: hidden; }
        ...
        nav ul a { font-size: 0.72rem; letter-spacing: 0.18em; text-transform: uppercase; color: var(--muted); transition: color 0.25s; font-weight: 400; }
        ...
        .hero { min-height: 100vh; display: flex; flex-direction: column; justify-content: flex-start; padding: 9rem 4rem 6rem; border-bottom: 1px solid var(--border); background: #000000; }
        .eyebrow { font-family: var(--mono); font-size: 0.72rem; letter-spacing: 0.22em; text-transform: uppercase; color: var(--denim-bright); margin-bottom: 2rem; }
        .hero h1 { font-size: clamp(2.2rem, 4.5vw, 4rem); line-height: 1.08; font-weight: 500; margin-bottom: 2.5rem; color: var(--silver-bright); letter-spacing: 0.01em; }
        .hero h1 em { font-style: normal; color: var(--denim-bright); }
        .subhead { font-size: 0.92rem; color: var(--muted); max-width: 60ch; margin-bottom: 0.9rem; line-height: 2; font-weight: 300; }
        .btn { display: inline-block; margin-top: 2rem; padding: 0.85rem 2rem; border: 1px solid var(--denim); font-size: 0.72rem; letter-spacing: 0.18em; text-transform: uppercase; color: var(--silver); font-family: var(--mono); background: rgba(42,74,127,0.12); transition: all 0.25s; }
        ...
        .pillar h3 { font-size: 0.88rem; font-weight: 500; margin-bottom: 1rem; color: var(--silver); letter-spacing: 0.1em; text-transform: uppercase; }
        .pillar p { font-size: 0.88rem; color: var(--muted); margin-bottom: 2rem; line-height: 2; font-weight: 300; }
        ...
        .contact h2 { font-size: clamp(1.4rem, 3vw, 2.4rem); font-weight: 400; margin-bottom: 3rem; color: var(--silver-bright); }
        .contact .eyebrow { margin-bottom: 1.2rem; }
        footer { display: flex; justify-content: space-between; align-items: center; padding: 1.8rem 4rem; font-family: var(--mono); font-size: 0.68rem; color: var(--muted); letter-spacing: 0.12em; background: #000000; }
        ...
        @media (max-width: 700px) {
          ...
          .hero h1 { font-size: clamp(2rem, 10vw, 3.5rem); margin-bottom: 1.5rem; }
          .eyebrow { font-size: 0.65rem; margin-bottom: 1.2rem; }
          .subhead { font-size: 0.88rem; max-width: 100%; }
