    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body { background: #000000; color: var(--text); font-family: var(--font); font-size: 18px; line-height: 1.7; font-weight: 400; overflow-x: hidden; }
        ...
        .hero h1 { font-size: clamp(3.5rem, 8vw, 8rem); line-height: 1.02; font-weight: 700; margin-bottom: 3.5rem; color: var(--silver-bright); letter-spacing: -0.01em; }
        .hero h1 em { font-style: normal; color: var(--denim-bright); }
        .subhead { font-size: 1.15rem; color: var(--muted); max-width: 58ch; margin-bottom: 1.8rem; line-height: 2.1; font-weight: 400; }
        ...
        .pillar h3 { font-size: 1.2rem; font-weight: 700; margin-bottom: 1.2rem; color: var(--silver); letter-spacing: 0.05em; text-transform: uppercase; }
        .pillar p { font-size: 1rem; color: var(--muted); margin-bottom: 2rem; line-height: 2; }
      ...
      <section className="hero">
        ...
        <p className="subhead">MyoMentia sits at the intersection of movement science, men&apos;s pelvic health, and perception research.</p>
        <p className="subhead">Movement is the intervention. Pelvic function is the outcome. Philosophy is the why underneath the why.</p>
