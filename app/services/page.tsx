    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card p { font-size: 0.82rem; color: var(--silver-bright); margin-bottom: 1.5rem; line-height: 1.9; }
        .card p.muted { color: var(--muted); font-style: italic; }
        ...
        <div className="cards">
          <div className="card">
            <div className="card-body">
              ...
              <p>Personalized movement programming delivered asynchronously through an app. Built around neuroscience-backed training principles, each program is designed for your body, your schedule, and your goals. No live calls, no rigid timetables. Just structured, intelligent training you can follow on your own time.</p>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <h3>Service Two</h3>
              <p className="muted">Stay tuned. This is still in development.</p>
            </div>
          </div>
          <div className="card">
            <div className="card-body">
